...
public class FuncionarioController {
	...
	/**
	 * Retorna um dto com dados do funcionário
	 * @param funcionario
	 * @return
	 */
	...
	/**
	 * Atualiza os dados do funcionário com base no dto
	 * @param funcionario
	...
	private void atualizarDadosFuncionario(Funcionario funcionario, FuncionarioDto funcionarioDto,
		...
		if(!funcionario.getEmail().equals(funcionarioDto.getEmail())) {
			this.funcionarioService.buscarPorEmail(funcionarioDto.getEmail())
				.ifPresent(func -> result.addError(new ObjectError("email", "Email existente")));
		...
		funcionarioDto.getQtdHorasTrabalhoDia().ifPresent(qtdHorasTrabahoDia -> funcionario.setQtdHorasTrabalhoDia(Float.valueOf(qtdHorasTrabahoDia)));
